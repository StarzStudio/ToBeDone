...
private extension Selector {
    static let buttonTapped = #selector(AlertView.buttonTapped)
    static let deviceOrientationDidChange = #selector(AlertView.deviceOrientationDidChange)
}
...
open class AlertView: UIView {
    ...
    var alertChoiceTable:    AlertChoicesTable!
    ...
    open func show(_ title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", callback: @escaping DatePickerCallback) {
